  ...
  for (let number = leftSide; number <= rightSide; number++) {
    items.push(
      <li
        key={number}
        className={
          `rounded-md cursor-pointer font-medium text-xl w-8 h-8 flex items-center justify-center ${number === currentPage ? " border-[#373737] border border-solid text-gray-800 " : "text-gray-600"}`
