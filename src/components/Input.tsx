...
export interface IPropsInputCustom {
  ...
  isError?: boolean;
  errorMessage?: string;
  type?: "text" | "email" | "password" | "text-area" | "date-time";
}
      ...
      <div className={`mb-2 ${className}`}>
        ...
        <div className="relative">
          <textarea
            ...
            className={`bg-gray-50 border text-sm rounded-lg focus:max-sm:ring-blue-500  focus:max-sm:border-blue-500 block w-full ${
