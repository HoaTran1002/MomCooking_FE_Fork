...
export const courses: ICoursesCardReview[] = [
  {
    title: "Viet Nam traditional course",
    subTitle:
      "We will teach you how to make pure, traditional Vietnamese dishes ",
    path: "/khoa-hoc/1",
    imgUrl: ImgCoursesAsia,
  },
  {
    title: "Kid cooking course",
    subTitle:
      "We will teach you how to make pure, traditional Vietnamese dishes ",
    path: "/khoa-hoc/1",
    imgUrl: ImgCoursesKid,
  },
  {
    title: "Bread cooking course",
    subTitle:
      "We will teach you how to make pure, traditional Vietnamese dishes ",
    path: "/khoa-hoc/1",
    imgUrl: ImgCoursesBread,
  },
  {
    title: "Viet Nam traditional course",
    subTitle:
