...
const CoursesItemCard = ({ ...props }: PropsCoursesItemCard): JSX.Element => {
  return (
    ...
    >
      <div className="before:absolute before:top-0 before:bottom-0 before:left-0 before:right-0 before:bg-black before:opacity-20"></div>
      <div className="relative p-5">
        <h3 className="text-white font-bold text-3xl">{props.name}</h3>
        <p className="text-white py-3">{props.description}</p>
      </div>
